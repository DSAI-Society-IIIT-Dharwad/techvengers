...
import { Home, Network, Palette, MessageSquare, Star, Image as GalleryIcon } from 'lucide-react'; // Added GalleryIcon
          ...
          <nav className="flex items-center gap-1 md:gap-2">
            ...
            <Button variant="ghost" asChild className="text-foreground hover:bg-primary/10">
              <Link href="/dashboard/gallery">
                <GalleryIcon className="mr-0 md:mr-2 h-4 w-4" /> <span className="hidden md:inline">Gallery</span>
              </Link>
            </Button>
            <Button variant="ghost" asChild className="text-foreground hover:bg-primary/10">
